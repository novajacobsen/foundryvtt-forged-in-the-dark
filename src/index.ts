...
Hooks.once("init", async () => {
  ...
  Handlebars.registerHelper(
    "is_turf_side",
    function (this: Handlebars.TemplateDelegate, value, options) {
  ...
  Handlebars.registerHelper(
    "traumacounter",
    function (this: Handlebars.TemplateDelegate, selected, options) {
      let html = options.fn(this);
  ...
  Handlebars.registerHelper(
    "repturf",
    function (this: Handlebars.TemplateDelegate, turfs_amount, options) {
      let html = options.fn(this);
  ...
  Handlebars.registerHelper(
    "crew_vault_coins",
    function (this: Handlebars.TemplateDelegate, max_coins, options) {
      let html = options.fn(this);
  ...
  Handlebars.registerHelper(
    "crew_experience",
    function (this: Handlebars.TemplateDelegate, options) {
      let html = options.fn(this);
      for (let i = 1; i <= 10; i++) {
        html +=
